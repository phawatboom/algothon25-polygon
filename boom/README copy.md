...
Run eval.py to view score + transactions data

Run backtester.py to view different graphs/charts (read readme inside johns-algothon-2025 for more info)
- Use left and right arrow to view long and short entries between different instruments
